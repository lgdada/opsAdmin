...
class CallbackModule(CallbackBase):
    ...
    def __init__(self, display=None):
        ...
        self.cc = None
        self.bcc = None
        self.mailto = "gaoliang@yingyinglicai.com,15079792983@163.com"
        self.mailfrom = "1296981881@qq.com"
        self.mailpasswd= "jetgovfjiyszjhgb"
    ...
    def mail(self, subject='Ansible error mail', body=None):
        ...
        #smtp = smtplib.SMTP_SSL(self.smtphost, port=self.smtpport)
        smtp = smtplib.SMTP_SSL("smtp.qq.com",smtplib.SMTP_SSL_PORT)
        #smtp.connect("smtp.qq.com",465)
        smtp.login(self.mailfrom,self.mailpasswd)
        ...
        msg['To']= self.mailto
        # print (subject)
        smtp.sendmail(self.mailfrom, self.mailto.split(','), msg.as_string())
